...
bool IMU_IS_GRAVITY_NEGATIVE = 0; //if imu is not moving is it showing -1.0?
double IMU_TOLERANCE = 0.1; //if set for 0.1 everything from 0.9 to 1.1 will count as gravity
